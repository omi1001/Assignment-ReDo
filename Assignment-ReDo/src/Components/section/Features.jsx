        ...
        {/* Program highlights */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <h3 className="text-lg font-bold text-iim-navy mb-2">100% Live Online</h3>
                ...
                >
                    ...
                    <h3 className="text-lg font-bold text-iim-navy mb-2">IIM Alumni Credentials</h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
                ...
                >
                    ...
                    <h3 className="text-lg font-bold text-iim-navy mb-2">Flexible 2-Year Format</h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    ...
                    <span className="bg-white/10 px-5 py-2 rounded-full border border-white/10 text-xs md:text-sm font-semibold">Marketing and Sales Strategy</span>
                    <span className="bg-white/10 px-5 py-2 rounded-full border border-white/10 text-xs md:text-sm font-semibold">Operations Management</span>
                </div>
            </div>
        </section>
    )
